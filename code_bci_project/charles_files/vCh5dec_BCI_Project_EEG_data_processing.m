...
% -------------------------------------------------
    ...
    for s=8:8%1:number_of_subjects 
...
% ---------------------------------------------------------------------------------    
    ...
    %
    %        4) perform visual inspection of epochs targeted as artefacts
    %           before rejection
    ...
    %
    %        5) remove artefacted epochs
    %           >>Tools>Reject data epochs>Reject marked epochs
    %
    %        4) save cleaned data as subject_X_data_cleaned.set in folder Cleaned_data
    %
    %        5) modify directly in its folder the format of file .set -> .mat 
